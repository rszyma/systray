...
See [![full API](https://pkg.go.dev/badge/github.com/rszyma/systray.svg)](https://pkg.go.dev/github.com/rszyma/systray) as well as [CHANGELOG](https://github.com/rszyma/systray/tree/master/CHANGELOG.md).
...
```sh
git clone https://github.com/rszyma/systray
cd systray/example
